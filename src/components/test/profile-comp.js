...
export function DisplayWallet({ network, address, theme }) {
      ...
      <div className={`mb-4 p-4 ${theme.selectedCard}`}>
        <div className="flex justify-between items-start">
          <div className="flex gap-3 items-center">
            <div>
              <IconWallet className="text-zinc-400 w-12 h-12" />
            </div>
            <div>
          ...
          <PortalExample showModal={showModal} setShowModal={setShowModal}>
            <EthereumQRCode
              qrCodeSrc="https://picsum.photos/256"
...
export function PortalExample({ children, showModal, setShowModal }) {
    return (
      <>
        {showModal &&
          createPortal(
            <div className="modal absolute top-0 left-0">
              <button
                className="modal absolute top-5 right-5"
...
export function EthereumQRCode({ qrCodeSrc, walletAddress }) {
    return (
      <div className="h-screen w-screen flex items-center justify-center bg-[#BDBDBDA8]">
...
export function DeployingSVG({ className, color = "#6c63ff" }) {
    return (
      <svg
        className={`${className}`}
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1050.8619 704.35284"
        data-src="https://cdn.undraw.co/illustrations/personal-information_gbtc.svg"
        role="img"
      >
        <path
        ...
        <g id="b96c6486-fa38-4cba-8e5e-13dca7f44a0c" data-name="Group 52">
          <path
            id="b0fbfc35-67c9-42b4-b2fe-33d0d7288754-1582"
            data-name="Path 846"
          ...
          />
          <path
            id="a6a8f1c9-3ab8-4f6f-ba9b-45acc2f7af89-1583"
            data-name="Path 852"
          ...
          />
          <path
            id="fc06e97d-785e-4845-9aa0-60a5889f9ce3-1584"
            data-name="Path 853"
          ...
          />
          <path
            id="b248559b-61d8-49e2-8eef-81cc9521c19e-1585"
            data-name="Path 855"
          ...
          />
          <path
            id="b0e9bc84-32e8-4599-bd8d-d35670d3692b-1586"
            data-name="Path 856"
          ...
          />
          <path
            id="b58b0f1b-b11b-4f57-8de2-a939101b4938-1587"
            data-name="Path 857"
          ...
          />
          <path
            id="b6bcc4bf-1738-426f-8fbf-3ee273a728b5-1588"
            data-name="Path 858"
          ...
          />
          <path
            id="be96ad09-85ff-4345-abef-5a49918f7c18-1589"
            data-name="Path 859"
        ...
        <g id="b2dad932-78e1-44e1-9682-073c8202f887" data-name="Group 51">
          <path
            id="e043db59-b600-449e-8c52-e1eb73379667-1590"
            data-name="Path 341"
        ...
        <path
          id="bcfa45dc-2c5a-4ac5-8376-9a2a23e225d0-1591"
          data-name="Path 842"
