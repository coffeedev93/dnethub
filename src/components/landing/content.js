...
export default function LandingContent({ siteConfig }) {
	const {
        protocol,
        rootHost,
        profileHost
    ...
    const MonoText = ({ children }) => (
        <span className="font-mono text-pink-500 bg-slate-200 px-1 rounded-sm">
            {children}
        </span>
    );
        ...
        <>
                        ...
                        <Link
                            ...
                            className={cn(
                                buttonVariants({
                                    size: "lg",
                                    className:
                                        "font-mono font-semibold bg-pink-500",
                                })
                            )}
                        >
                            Get Started
            ...
            >
                <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                    ...
                    <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                        Experience a seamless web3 domains integration without
                        the hassle of browser extensions. Unlock the future of{" "}
                        the Decentralized Name Services now!{" "}
                    </p>
                </div>
            </section>
        </>
